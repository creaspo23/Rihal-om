    ...
    <layout>
        <div class="mt-8">
            <div class="flex justify-between">
                <h2 class="text-3xl text-gray-700 font-bold">Countries</h2>
                <div>
                    ...
                    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6">
                        <div
                            ...
                            <table class="min-w-full">
                                ...
                                <tr class="border-b border-gray-200" v-for="country in countries" :key="country.index">
                                    ...
                                    <td class="flex px-6 py-4 whitespace-no-wrap text-sm leading-5 font-medium">
                                        ...
                                        <button @click="Delete(country)" class="focus:outline-none outline-none">
